...
public class Game extends DisplayObjectContainer implements ActionListener, KeyListener {
	...
	public Game(String gameId, int width, int height) {
		...
		keyTimer=new Timer(1000,changeToggleState);
		toggleTimeOut = false;
	}
	...
	ActionListener changeToggleState = new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			toggleTimeOut = false;
		}
	};
	...
	public boolean getToggleTimeOut() {
		return toggleTimeOut;
	}
	
	public void setToggleTimeOut(boolean b) {
		toggleTimeOut = b;
	}
}
